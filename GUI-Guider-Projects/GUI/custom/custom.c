...
lv_obj_t *game_2048_label_end;
lv_obj_t *game_2048_score;
...
void custom_init(lv_ui *ui)
{
  ...
  game_2048_label_end=ui->game_2048_label_end;
  game_2048_score=ui->game_2048_score;
...
char exp_bi[1000];
int ebcnt;
char exp_a[1000], exp_b[1000], exp_c[1000], exp_d[1000];
...
void game_init(){
  ...
  score=0;
  addRandom(board);
  if(score<findMax(board)) score = findMax(board);
  show_board();
}